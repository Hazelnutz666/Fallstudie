...
package Quiz;
   ...
   interface Zahlenfrage {
     ...
     //liefert true wenn die Methode legeAntwortFest() schon mindestens einmal ausgeführt wurde, ansonsten false
     public  boolean istBeantwortet();
    
    
     //liefert true wenn die Frage schon beantwortet wurde und die Antwort richtig war, ansonsten false#
...
//liefert die Anzahl der erreichten Punkte, abhängig von der Korrektheit der Antwort
